...
wget https://raw.githubusercontent.com/Cloud-Wala-Banda/Labs-Solutions/main/Use%20Machine%20Learning%20APIs%20on%20Google%20Cloud%20Challenge%20Lab/analyze-images-v2.py
